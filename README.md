...
[![R-CMD-check](https://github.com/mayageorgeglenn/sparseNumeric/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/mayageorgeglenn/sparseNumeric/actions/workflows/R-CMD-check.yaml)
